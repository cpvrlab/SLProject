...
cp -r "libmediapipe/output/libmediapipe-$VERSION-x86_64-macos/lib" "$PREBUILT_DIR/debug/lib"
...
cp -r "libmediapipe/output/libmediapipe-$VERSION-x86_64-macos/lib" "$PREBUILT_DIR/release/lib"

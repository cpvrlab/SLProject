...
static std::string computerModel = "MODEL?";
static std::string computerOS    = "OS?";
static std::string computerOSVer = "OSVER?";
static std::string computerArch  = "ARCH?";
static std::string computerID    = "ID?";

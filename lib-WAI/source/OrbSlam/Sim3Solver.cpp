...
Sim3Solver::Sim3Solver(WAIKeyFrame* pKF1, WAIKeyFrame* pKF2, const vector<WAIMapPoint*>& vpMatched12, const bool bFixScale) : mnIterations(0), mnBestInliers(0), mbFixScale(bFixScale)
{
    mpKF1 = pKF1;
    mpKF2 = pKF2;
    ...
    for (int i1 = 0; i1 < mN1; i1++)
    {
        if (vpMatched12[i1])
        {
            WAIMapPoint* pMP1 = vpKeyFrameMP1[i1];
            WAIMapPoint* pMP2 = vpMatched12[i1];

...
elseif("${SYSTEM_NAME_UPPER}" STREQUAL "WINDOWS") #----------------------------
    ...
    # Set output folder special for VS
    set(BINDIR_WIN64 "${CMAKE_CURRENT_SOURCE_DIR}/_bin-win64")
    set(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${BINDIR_WIN64})
    set(CMAKE_LIBRARY_OUTPUT_DIRECTORY ${BINDIR_WIN64})
    set(CMAKE_ARCHIVE_OUTPUT_DIRECTORY ${BINDIR_WIN64})
    foreach(OUTPUTCONFIG ${CMAKE_CONFIGURATION_TYPES})
        string(TOUPPER ${OUTPUTCONFIG} OUTPUTCONFIGUP)
        set(CMAKE_RUNTIME_OUTPUT_DIRECTORY_${OUTPUTCONFIGUP} ${BINDIR_WIN64})
        set(CMAKE_LIBRARY_OUTPUT_DIRECTORY_${OUTPUTCONFIGUP} ${BINDIR_WIN64})
        set(CMAKE_ARCHIVE_OUTPUT_DIRECTORY_${OUTPUTCONFIGUP} ${BINDIR_WIN64})

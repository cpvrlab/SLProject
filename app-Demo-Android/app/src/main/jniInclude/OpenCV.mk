...
OPENCV_MODULES:=stitching superres videostab aruco bgsegm bioinspired ccalib dpm fuzzy line_descriptor optflow reg saliency stereo structured_light phase_unwrapping rgbd surface_matching tracking datasets text face plot xfeatures2d shape video ximgproc calib3d features2d flann xobjdetect objdetect ml xphoto highgui videoio imgcodecs photo imgproc core

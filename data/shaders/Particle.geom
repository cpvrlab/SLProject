...
void main (void)
{
  ...
  //BOTTOM RIGHT
  vec4 vd = vec4((P.xy + (rot * vec2(u_radius, -u_radius))) * u_scale, P.z * u_scale,1);
  ...
  //TOP LEFT
  vec4 vb = vec4((P.xy + (rot * vec2(-u_radius,u_radius))) * u_scale, P.z * u_scale,1);
  ...
  //TOP RIGHT
  vec4 vc = vec4((P.xy + (rot *vec2(u_radius, u_radius))) * u_scale, P.z * u_scale,1);

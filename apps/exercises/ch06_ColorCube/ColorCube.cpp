...
void onInit()
{
    ...
    _shaderVertID = glUtils::buildShader(_projectRoot + "/data/shaders/ch06_ColorCube.vert", GL_VERTEX_SHADER);
    _shaderFragID = glUtils::buildShader(_projectRoot + "/data/shaders/ch06_ColorCube.frag", GL_FRAGMENT_SHADER);
...
int main(int argc, char* argv[])
{
    ...
    initGLFW(_scrWidth, _scrHeight, "ColorCube");

...
void onInit()
{
    ...
    _shaderVertID = glUtils::buildShader(_projectRoot + "/_data/shaders/ColorAttribute.vert", GL_VERTEX_SHADER);
    _shaderFragID = glUtils::buildShader(_projectRoot + "/_data/shaders/Color.frag", GL_FRAGMENT_SHADER);

//#############################################################################
//  File:      AppPenTrackingMainGLFW.cpp
//  Date:      October 2021
...
//-----------------------------------------------------------------------------
//! Forward declaration of the scene definition function from AppPenTrackingLoad.cpp
...
SLbool onPaint()
{
    ...
    {
        AppPenTracking::instance().grabFrameImagesAndTrack(sv);
    }
    ...
    // Show a custom title as opposed to the title generated by the scene library
    char string[64];
    sprintf(string, "Pen Tracker (%.0f FPS)", AppDemo::scene->fps());
                                    ...
                                    SLInputManager& inputManager)
{
    ...
    return new AppPenTrackingSceneView(scene, curDPI, inputManager);
}
//-----------------------------------------------------------------------------
...
void initSL(SLVstring& cmdLineArgs)
{
    ...
    /////////////////////////////////////////////////////////
    AppPenTracking::instance().openCaptureProviders();
    /////////////////////////////////////////////////////////
...
//    {
        ...
        AppPenTracking::instance().closeCaptureProviders();
        slTerminate();

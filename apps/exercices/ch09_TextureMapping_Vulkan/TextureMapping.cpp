...
void TextureMapping::initWindow()
{
    glfwInit();
...
void TextureMapping::initVulkan()
{
    createInstance();
    setupDebugMessenger();
    createSurface();
...
void TextureMapping::cleanupSwapchain()
{
...
void TextureMapping::recreateSwapchain()
{
...
void TextureMapping::createInstance()
{
#if IS_DEBUGMODE_ON
    ...
    appInfo.pApplicationName   = "TextureMapping_Vulkan";
...
void TextureMapping::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo)
{
    createInfo                 = {};
...
void TextureMapping::setupDebugMessenger()
{
#if !IS_DEBUGMODE_ON
    return;
#endif
...
void TextureMapping::createSurface()
{
    if (glfwCreateWindowSurface(instance, window, nullptr, &surface) != VK_SUCCESS)
        throw std::runtime_error("failed to create window surface!");
}

void TextureMapping::pickPhysicalDevice()
{
...
void TextureMapping::createLogicalDevice()
{
...
void TextureMapping::createSwapchain()
{
...
void TextureMapping::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout)
{
...
void TextureMapping::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height)
{
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void TextureMapping::createIndexBuffer()
{
 ...
 void TextureMapping::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory)
{
...
void TextureMapping::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size)
{
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void TextureMapping::createCommandBuffers()
{
...
void TextureMapping::createSyncObjects()
{
...
VkShaderModule TextureMapping::createShaderModule(const std::vector<char>& code)
{
...
SwapchainSupportDetails TextureMapping::querySwapchainSupport(VkPhysicalDevice device)
{
...
bool TextureMapping::isDeviceSuitable(VkPhysicalDevice device)
{
...
bool TextureMapping::checkDeviceExtensionSupport(VkPhysicalDevice device)
{
...
uint32_t TextureMapping::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties)
{
...
VkCommandBuffer TextureMapping::beginSingleTimeCommands()
{
    VkCommandBufferAllocateInfo allocInfo = {};
    allocInfo.sType                       = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
    allocInfo.level                       = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
...
void TextureMapping::endSingleTimeCommands(VkCommandBuffer commandBuffer)
{
...
VkImageView TextureMapping::createImageView(VkImage image, VkFormat format)
{
...
QueueFamilyIndices TextureMapping::findQueueFamilies(VkPhysicalDevice device)
{
...
std::vector<const char*> TextureMapping::getRequiredExtensions()
{
...
bool TextureMapping::checkValidationLayerSupport()
{
    uint32_t layerCount;
...
void TextureMapping::DestroyDebugUtilsMessengerEXT(VkInstance instance, VkDebugUtilsMessengerEXT debugMessenger, const VkAllocationCallbacks* pAllocator)
{

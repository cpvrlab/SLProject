...
void onInit()
{
    ...
    _shaderVertID = glUtils::buildShader(_projectRoot + "/data/shaders/ColorCube.vert", GL_VERTEX_SHADER);
    _shaderFragID = glUtils::buildShader(_projectRoot + "/data/shaders/ColorCube.frag", GL_FRAGMENT_SHADER);

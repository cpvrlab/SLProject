...
{
    auto condition = [&] {
        return (_initialized && _cameraAvailability[_cameraId]);
    };
    ...
    _cameraDeviceOpenResult = ACameraManager_openCamera(_cameraManager, _cameraId.c_str(), &cameraDeviceListener, &_cameraDevice);
    {

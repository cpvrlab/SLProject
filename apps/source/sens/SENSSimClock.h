...
public:
    ...
    SENSTimePt now() const
    {
        ...
        if (_pause)
        {
            ...
            passedSimTime = std::chrono::duration_cast<SENSMicroseconds>((SENSTimePt)SENSClock::now() - _pauseTimePt);
        }
        else
        {
            passedSimTime = std::chrono::duration_cast<SENSMicroseconds>((SENSTimePt)SENSClock::now() - _startTimePt);
        }

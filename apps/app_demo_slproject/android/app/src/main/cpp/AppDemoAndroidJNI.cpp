...
JNIEXPORT void JNICALL Java_ch_bfh_cpvrlab_GLES3Lib_onRotationQUAT(JNIEnv* env, jclass obj, jfloat quatX, jfloat quatY, jfloat quatZ, jfloat quatW);
JNIEXPORT bool JNICALL Java_ch_bfh_cpvrlab_GLES3Lib_usesLocation(JNIEnv* env, jclass obj);
JNIEXPORT void JNICALL Java_ch_bfh_cpvrlab_GLES3Lib_onLocationLatLonAlt(JNIEnv* env, jclass obj, jdouble latitudeDEG, jdouble longitudeDEG, jdouble altitudeM, jfloat accuracyM);
JNIEXPORT jint JNICALL Java_ch_bfh_cpvrlab_GLES3Lib_getVideoType(JNIEnv* env, jclass obj);
JNIEXPORT jint JNICALL Java_ch_bfh_cpvrlab_GLES3Lib_getVideoSizeIndex(JNIEnv* env, jclass obj);
JNIEXPORT void JNICALL Java_ch_bfh_cpvrlab_GLES3Lib_grabVideoFileFrame(JNIEnv* env, jclass obj);
JNIEXPORT void JNICALL Java_ch_bfh_cpvrlab_GLES3Lib_copyVideoImage(JNIEnv* env, jclass obj, jint imgWidth, jint imgHeight, jbyteArray srcBuffer);
JNIEXPORT void JNICALL Java_ch_bfh_cpvrlab_GLES3Lib_onSetupExternalDir(JNIEnv* env, jclass obj, jstring externalDirPath);
...
//-----------------------------------------------------------------------------
extern "C" JNIEXPORT void JNICALL Java_ch_bfh_cpvrlab_GLES3Lib_onTerminate(JNIEnv* env, jclass obj)
{
    slTerminate();
}
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
extern "C" JNIEXPORT void JNICALL Java_ch_bfh_cpvrlab_GLES3Lib_onTouch2Down(JNIEnv* env, jclass obj, jint x1, jint y1, jint x2, jint y2)
{
...
//-----------------------------------------------------------------------------
extern "C" JNIEXPORT void JNICALL Java_ch_bfh_cpvrlab_GLES3Lib_onRotationQUAT(JNIEnv* env, jclass obj, jfloat quatX, jfloat quatY, jfloat quatZ, jfloat quatW)
{
    slRotationQUAT(quatX, quatY, quatZ, quatW);
}
//-----------------------------------------------------------------------------
extern "C" JNIEXPORT void JNICALL Java_ch_bfh_cpvrlab_GLES3Lib_onClose(JNIEnv* env, jclass obj)
{
    SL_LOG("onClose");
    slTerminate();
}
//-----------------------------------------------------------------------------
extern "C" JNIEXPORT bool JNICALL Java_ch_bfh_cpvrlab_GLES3Lib_usesRotation(JNIEnv* env, jclass obj)
{
...
extern "C" JNIEXPORT
  jint JNICALL
  Java_ch_bfh_cpvrlab_GLES3Lib_getVideoType(JNIEnv* env, jclass obj)
{
...
extern "C" JNIEXPORT
  jint JNICALL
  Java_ch_bfh_cpvrlab_GLES3Lib_getVideoSizeIndex(JNIEnv* env, jclass obj)
{
...
extern "C" JNIEXPORT void JNICALL Java_ch_bfh_cpvrlab_GLES3Lib_copyVideoImage(JNIEnv* env, jclass obj, jint imgWidth, jint imgHeight, jbyteArray imgBuffer)
{
...
extern "C" JNIEXPORT bool JNICALL Java_ch_bfh_cpvrlab_GLES3Lib_usesLocation(JNIEnv* env, jclass obj)
{

...
static std::string hGaussian1chFs = "#version 330\n"
                                    ...
                                    "0.036658041953378, 0.230066298993809, 0.6925693242051977, 1.0, 0.6925693242051979, 0.2300662989938092, 0.036658041953378045);"
                                    "\n"
                                    "    \n"
                                    "    float response = 0.0;\n"
                                    "    for (int i = 0; i < 7; i++)\n"
...
static std::string nmszFs = "#version 330\n"
                            ...
                            "{\n"
                            "    \n"
                            "    float l0 = texture(det, texcoords).r;\n"
                            "    float l1 = texture(det, texcoords).g;\n"
                            "    float l2 = texture(det, texcoords).b;\n"
                            "    float gxx = texture(tgxx, texcoords).g;\n"
                            "    float gyy = texture(tgyy, texcoords).g;\n"
                            "    float gxy = texture(tgxy, texcoords).g;\n"
                            "    float tr = gxx + gyy;\n"
                            "    float r = tr * tr / l1;\n"
                            "    pixel = 0.0;\n"
                            "    if (r < 5.0 && l1 > 0.0 && l1 > l0 && l1 > l2)\n"
                            "       pixel = l1;\n"
                            "}\n";

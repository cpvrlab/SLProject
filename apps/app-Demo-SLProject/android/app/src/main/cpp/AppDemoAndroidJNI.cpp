...
extern "C" JNIEXPORT void JNICALL Java_ch_fhnw_comgr_GLES3Lib_onInit(JNIEnv* env, jclass obj, jint width, jint height, jint dpi, jstring filePath)
{
    ...
    CVImage::defaultPath         = devicePath + "/data/images/textures/";
    CVCapture::instance()->loadCalibrations(Utils::ComputerInfos::get(), // deviceInfo string
                                            ...
                                            devicePath + "/data/videos/");          // for videos
...
//-----------------------------------------------------------------------------
extern "C" JNIEXPORT bool JNICALL Java_ch_fhnw_comgr_GLES3Lib_onUpdateVideo(JNIEnv* env, jclass obj)
{
...
extern "C" JNIEXPORT bool JNICALL Java_ch_fhnw_comgr_GLES3Lib_usesLocation(JNIEnv* env, jclass obj)
{

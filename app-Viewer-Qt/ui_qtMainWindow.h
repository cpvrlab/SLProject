...
public:
    ...
    QAction *actionFind_degenerated;
    QAction *actionLoad_Asset;
    QAction *actionSplit_large_meshes;
    QAction *actionJoin_identical_vertices;
    QAction *actionFind_invalid_data;
    QAction *actionFix_infacing_normals;
    QAction *actionSort_by_primitive_type;
    QAction *actionRemove_redundant_materials;
    QAction *actionUse_dark_ui;
    QAction *actionImport_Asset;
    QAction *actionGenerate_smooth_normals;
    QAction *actionSet_default_settings;
    QAction *actionShow_process_info;
    QAction *actionVisit_SLProject_on_Github;
    QAction *actionVisit_cpvrLab_homepage;
    QAction *actionSintel;
    ...
    void setupUi(QMainWindow *qtMainWindow)
    {
        ...
        qtMainWindow->setMinimumSize(QSize(600, 400));
        ...
        actionFrustum_Culling = new QAction(qtMainWindow);
        actionFrustum_Culling->setObjectName(QStringLiteral("actionFrustum_Culling"));
        actionFrustum_Culling->setCheckable(true);
        ...
        actionShow_Skeleton = new QAction(qtMainWindow);
        actionShow_Skeleton->setObjectName(QStringLiteral("actionShow_Skeleton"));
        actionShow_Skeleton->setCheckable(true);
        QIcon icon26;
        icon26.addFile(QStringLiteral(":/images/showSkeleton.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionShow_Skeleton->setIcon(icon26);
        actionClose_Scene = new QAction(qtMainWindow);
        actionClose_Scene->setObjectName(QStringLiteral("actionClose_Scene"));
        actionFind_degenerated = new QAction(qtMainWindow);
        actionFind_degenerated->setObjectName(QStringLiteral("actionFind_degenerated"));
        actionFind_degenerated->setCheckable(true);
        actionFind_degenerated->setChecked(true);
        actionLoad_Asset = new QAction(qtMainWindow);
        actionLoad_Asset->setObjectName(QStringLiteral("actionLoad_Asset"));
        actionSplit_large_meshes = new QAction(qtMainWindow);
        actionSplit_large_meshes->setObjectName(QStringLiteral("actionSplit_large_meshes"));
        actionSplit_large_meshes->setCheckable(true);
        actionSplit_large_meshes->setChecked(true);
        actionJoin_identical_vertices = new QAction(qtMainWindow);
        actionJoin_identical_vertices->setObjectName(QStringLiteral("actionJoin_identical_vertices"));
        actionJoin_identical_vertices->setCheckable(true);
        actionJoin_identical_vertices->setChecked(true);
        actionFind_invalid_data = new QAction(qtMainWindow);
        actionFind_invalid_data->setObjectName(QStringLiteral("actionFind_invalid_data"));
        actionFind_invalid_data->setCheckable(true);
        actionFind_invalid_data->setChecked(true);
        actionFix_infacing_normals = new QAction(qtMainWindow);
        actionFix_infacing_normals->setObjectName(QStringLiteral("actionFix_infacing_normals"));
        actionFix_infacing_normals->setCheckable(true);
        actionFix_infacing_normals->setChecked(true);
        actionSort_by_primitive_type = new QAction(qtMainWindow);
        actionSort_by_primitive_type->setObjectName(QStringLiteral("actionSort_by_primitive_type"));
        actionSort_by_primitive_type->setCheckable(true);
        actionSort_by_primitive_type->setChecked(true);
        actionRemove_redundant_materials = new QAction(qtMainWindow);
        actionRemove_redundant_materials->setObjectName(QStringLiteral("actionRemove_redundant_materials"));
        actionRemove_redundant_materials->setCheckable(true);
        actionRemove_redundant_materials->setChecked(true);
        actionUse_dark_ui = new QAction(qtMainWindow);
        actionUse_dark_ui->setObjectName(QStringLiteral("actionUse_dark_ui"));
        actionUse_dark_ui->setCheckable(true);
        actionImport_Asset = new QAction(qtMainWindow);
        actionImport_Asset->setObjectName(QStringLiteral("actionImport_Asset"));
        actionGenerate_smooth_normals = new QAction(qtMainWindow);
        actionGenerate_smooth_normals->setObjectName(QStringLiteral("actionGenerate_smooth_normals"));
        actionGenerate_smooth_normals->setCheckable(true);
        actionGenerate_smooth_normals->setChecked(true);
        actionSet_default_settings = new QAction(qtMainWindow);
        actionSet_default_settings->setObjectName(QStringLiteral("actionSet_default_settings"));
        actionShow_process_info = new QAction(qtMainWindow);
        actionShow_process_info->setObjectName(QStringLiteral("actionShow_process_info"));
        actionVisit_SLProject_on_Github = new QAction(qtMainWindow);
        actionVisit_SLProject_on_Github->setObjectName(QStringLiteral("actionVisit_SLProject_on_Github"));
        actionVisit_cpvrLab_homepage = new QAction(qtMainWindow);
        actionVisit_cpvrLab_homepage->setObjectName(QStringLiteral("actionVisit_cpvrLab_homepage"));
        actionSintel = new QAction(qtMainWindow);
        actionSintel->setObjectName(QStringLiteral("actionSintel"));
        actionSintel->setCheckable(true);
        ...
        menuLoad_Settings = new QMenu(menuFile);
        menuLoad_Settings->setObjectName(QStringLiteral("menuLoad_Settings"));
        ...
        dockScenegraph->setMouseTracking(false);
        ...
        dockProperties->setMouseTracking(false);
        ...
        dockAnimation->setMouseTracking(false);
...
"}"));
        ...
        QIcon icon27;
        icon27.addFile(QStringLiteral(":/images/animGoToStart.png"), QSize(), QIcon::Normal, QIcon::Off);
        animSkipStartButton->setIcon(icon27);
        ...
        QIcon icon28;
        icon28.addFile(QStringLiteral(":/images/animPrevKF.png"), QSize(), QIcon::Normal, QIcon::Off);
        animPrevKeyframeButton->setIcon(icon28);
        ...
        QIcon icon29;
        icon29.addFile(QStringLiteral(":/images/animPlayBackwards.png"), QSize(), QIcon::Normal, QIcon::Off);
        animPlayBackwardButton->setIcon(icon29);
        ...
        QIcon icon30;
        icon30.addFile(QStringLiteral(":/images/animStop.png"), QSize(), QIcon::Normal, QIcon::Off);
        animStopButton->setIcon(icon30);
        ...
        QIcon icon31;
        icon31.addFile(QStringLiteral(":/images/animPause.png"), QSize(), QIcon::Normal, QIcon::Off);
        animPauseButton->setIcon(icon31);
        ...
        QIcon icon32;
        icon32.addFile(QStringLiteral(":/images/animPlay.png"), QSize(), QIcon::Normal, QIcon::Off);
        animPlayForwardButton->setIcon(icon32);
        ...
        QIcon icon33;
        icon33.addFile(QStringLiteral(":/images/animNextKF.png"), QSize(), QIcon::Normal, QIcon::Off);
        animNextKeyframeButton->setIcon(icon33);
        ...
        QIcon icon34;
        icon34.addFile(QStringLiteral(":/images/animGoToEnd.png"), QSize(), QIcon::Normal, QIcon::Off);
        animSkipEndButton->setIcon(icon34);
        ...
        menuFile->addAction(actionLoad_Asset);
        menuFile->addAction(actionImport_Asset);
        menuFile->addAction(menuLoad_Settings->menuAction());
        ...
        menuGeneral_Scenes->addAction(actionFrustum_Culling);
        ...
        menuLoad_Settings->addAction(actionSet_default_settings);
        menuLoad_Settings->addSeparator();
        menuLoad_Settings->addAction(actionGenerate_smooth_normals);
        menuLoad_Settings->addAction(actionFind_degenerated);
        menuLoad_Settings->addAction(actionSplit_large_meshes);
        menuLoad_Settings->addAction(actionJoin_identical_vertices);
        menuLoad_Settings->addAction(actionFind_invalid_data);
        menuLoad_Settings->addAction(actionFix_infacing_normals);
        menuLoad_Settings->addAction(actionRemove_redundant_materials);
        menuLoad_Settings->addSeparator();
        menuLoad_Settings->addAction(actionShow_process_info);
        ...
        menuRender_Flags->addAction(actionShow_Skeleton);
        ...
        menuWindow->addAction(actionUse_dark_ui);
        menuHelp->addAction(actionAbout_SLProject);
        menuHelp->addAction(actionVisit_SLProject_on_Github);
        menuHelp->addAction(actionVisit_cpvrLab_homepage);
    ...
    void retranslateUi(QMainWindow *qtMainWindow)
    {
        ...
        actionQuit->setText(QApplication::translate("qtMainWindow", "Quit", 0));
#ifndef QT_NO_TOOLTIP
        actionQuit->setToolTip(QApplication::translate("qtMainWindow", "Quit the application", 0));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_STATUSTIP
        actionFrustum_Culling->setText(QApplication::translate("qtMainWindow", "Frustum Culling 1", 0));
#ifndef QT_NO_STATUSTIP
        actionFrustum_Culling->setStatusTip(QApplication::translate("qtMainWindow", "Loads a scene with many spheres out of the view frustum for testing the frustum culling.", 0));
#endif // QT_NO_STATUSTIP
        ...
        actionAstroboy_Army_CPU->setText(QApplication::translate("qtMainWindow", "Astroboy Army", 0));
#ifndef QT_NO_STATUSTIP
...
#endif // QT_NO_STATUSTIP
        actionShow_Skeleton->setText(QApplication::translate("qtMainWindow", "Show Skeleton", 0));
#ifndef QT_NO_STATUSTIP
        actionShow_Skeleton->setStatusTip(QApplication::translate("qtMainWindow", "Shows the skeleton joint axis in RGB, their parent bone in yellow and the parent offset in pink.", 0));
#endif // QT_NO_STATUSTIP
        actionClose_Scene->setText(QApplication::translate("qtMainWindow", "Close Scene", 0));
#ifndef QT_NO_TOOLTIP
        actionClose_Scene->setToolTip(QApplication::translate("qtMainWindow", "Closes the current Scene", 0));
#endif // QT_NO_TOOLTIP
        actionFind_degenerated->setText(QApplication::translate("qtMainWindow", "Find degenerated primitives", 0));
        actionLoad_Asset->setText(QApplication::translate("qtMainWindow", "Load Scene Assets from File", 0));
#ifndef QT_NO_TOOLTIP
        actionLoad_Asset->setToolTip(QApplication::translate("qtMainWindow", "Loads a new scene from a 3D asset file", 0));
#endif // QT_NO_TOOLTIP
        actionSplit_large_meshes->setText(QApplication::translate("qtMainWindow", "Split large meshes", 0));
        actionJoin_identical_vertices->setText(QApplication::translate("qtMainWindow", "Join identical vertices", 0));
        actionFind_invalid_data->setText(QApplication::translate("qtMainWindow", "Find invalid data", 0));
        actionFix_infacing_normals->setText(QApplication::translate("qtMainWindow", "Fix infacing normals", 0));
        actionSort_by_primitive_type->setText(QApplication::translate("qtMainWindow", "Sort by primitive type", 0));
        actionRemove_redundant_materials->setText(QApplication::translate("qtMainWindow", "Remove redundant materials", 0));
        actionUse_dark_ui->setText(QApplication::translate("qtMainWindow", "Use dark user interface (after restart)", 0));
        actionImport_Asset->setText(QApplication::translate("qtMainWindow", "Import Scene Assets from File", 0));
#ifndef QT_NO_TOOLTIP
        actionImport_Asset->setToolTip(QApplication::translate("qtMainWindow", "Adds the scene contents from a 3D asset files to the current scene", 0));
#endif // QT_NO_TOOLTIP
        actionGenerate_smooth_normals->setText(QApplication::translate("qtMainWindow", "Generate smooth normals", 0));
        actionSet_default_settings->setText(QApplication::translate("qtMainWindow", "Set default settings", 0));
#ifndef QT_NO_TOOLTIP
        actionSet_default_settings->setToolTip(QApplication::translate("qtMainWindow", "Sets proposeed default settings", 0));
#endif // QT_NO_TOOLTIP
        actionShow_process_info->setText(QApplication::translate("qtMainWindow", "Show more information on these settings", 0));
#ifndef QT_NO_TOOLTIP
        actionShow_process_info->setToolTip(QApplication::translate("qtMainWindow", "Opens the ASSIMP doc page on the process settings.", 0));
#endif // QT_NO_TOOLTIP
        actionVisit_SLProject_on_Github->setText(QApplication::translate("qtMainWindow", "Visit SLProject on Github", 0));
        actionVisit_cpvrLab_homepage->setText(QApplication::translate("qtMainWindow", "Visit cpvrLab homepage", 0));
#ifndef QT_NO_TOOLTIP
        actionVisit_cpvrLab_homepage->setToolTip(QApplication::translate("qtMainWindow", "Visit cpvrLab homepage", 0));
#endif // QT_NO_TOOLTIP
        actionSintel->setText(QApplication::translate("qtMainWindow", "Sintel Character", 0));
        menuFile->setTitle(QApplication::translate("qtMainWindow", "File", 0));
        menuLoad_Scene->setTitle(QApplication::translate("qtMainWindow", "Load Test Scene", 0));
        ...
        menuLoad_Settings->setTitle(QApplication::translate("qtMainWindow", "Load Settings", 0));

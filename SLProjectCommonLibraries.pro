...
unix:!macx:!android {
    ...
    LIBS += -lg2o_types_sba
    LIBS += /usr/local/lib64/libopencv_aruco.so
    LIBS += /usr/local/lib64/libopencv_core.so
    LIBS += /usr/local/lib64/libopencv_calib3d.so
    ...
    LIBS += /usr/local/lib64/libopencv_video.so
    LIBS += /usr/local/lib64/libopencv_videoio.so
    LIBS += /usr/local/lib64/libopencv_xfeatures2d.so

...
Initializer::Initializer(const WAIFrame& ReferenceFrame, float sigma, int iterations)
{
                                          ...
                                          int                              minTriangulated)
{
    ...
    {
        float parallax;
        int   nGood   = CheckRT(R21, t21, mvKeys1, mvKeys2, mvMatches12, vMatchesInliers, mK, vP3D, 4.0f * mSigma2, vbTriangulated, parallax);
        int   maxGood = nGood;

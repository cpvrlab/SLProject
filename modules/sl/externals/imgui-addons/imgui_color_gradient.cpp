                              ...
                              float                height)
{
    ...
    ImGui::SetCursorScreenPos(ImVec2(bar_pos.x,
                                     bar_pos.y + height + 20.0f));
}
//-------------------------------------------------------------------------
bool GradientButton(ImGradient* gradient)
{
    ...
    bool  clicked  = ImGui::InvisibleButton("gradient_bar",
                                          ImVec2(maxWidth,
                                                 GRADIENT_BAR_WIDGET_HEIGHT));

    DrawGradientBar(gradient,
                    widget_pos,
                    maxWidth,
                    GRADIENT_BAR_WIDGET_HEIGHT);
                    ...
                    ImGradientMark*& selectedMark)
{
    ...
    ImGui::InvisibleButton("gradient_editor_bar",
    ...
    if (ImGui::IsItemHovered() && ImGui::IsMouseClicked(0))
    {
        ...
        gradient->addMark(pos,
                          ImColor(newMarkCol[0],
                                  newMarkCol[1],
                                  newMarkCol[2]));
    }
    ...
    DrawGradientBar(gradient,
                    bar_pos,
                    maxWidth,
                    GRADIENT_BAR_EDITOR_HEIGHT);
    DrawGradientMarks(gradient,
                      draggingMark,
                      selectedMark,
                      bar_pos,
                      maxWidth,
    ...
    if (selectedMark)
    {
        bool colorModified = ImGui::ColorPicker3("Color gradient editor", selectedMark->color);

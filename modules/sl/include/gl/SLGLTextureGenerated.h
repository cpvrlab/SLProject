...
public:
    ...
    virtual SLuint width() { return _generatedWidth; }
    virtual SLuint height() { return _generatedHeight; }
...
protected:
    ...
    SLuint           _generatedWidth;         //! Generated width of texture (there is no _image in SLGLTexture)
    SLuint           _generatedHeight;        //! Generated height of texture (there is no _image in SLGLTexture)

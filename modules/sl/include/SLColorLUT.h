...
//-----------------------------------------------------------------------------
//! SLColorLUT defines a lookup table as an 1D texture of (256) RGBA values
/*! SLColorLUT defines an RGBA color lookup table (LUT). It can be used to
...
*/
class SLColorLUT : public SLGLTexture
  , public SLEventHandler
{
public:
    SLColorLUT(SLAssetManager* assetMgr,

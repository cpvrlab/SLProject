...
*/
string
glUtils::loadShader(string filename)
{
...
*/
GLuint
glUtils::buildShader(string shaderFile,
                     GLenum shaderType)
{
...
*/
GLuint
glUtils::buildTexture(string textureFile,
                      GLint  min_filter,
                      GLint  mag_filter,
                      GLint  wrapS,
                      GLint  wrapT)
...
//-----------------------------------------------------------------------------
GLuint
glUtils::build3DTexture(const std::vector<std::string>& files,
                        int&                            x_extend,
                        int&                            y_extend,
                        int&                            z_extend,
                        GLint                           min_filter,

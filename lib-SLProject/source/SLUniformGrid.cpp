...
{  
    ...
    SLfloat maxS = Utils::max(size.x, size.y, size.z);
    ...
    {  
        ...
        SLVec3f minT = SLVec3f(Utils::min(vert[0][0], vert[1][0], vert[2][0]),
                               Utils::min(vert[0][1], vert[1][1], vert[2][1]),
                               Utils::min(vert[0][2], vert[1][2], vert[2][2]));
        SLVec3f maxT = SLVec3f(Utils::max(vert[0][0], vert[1][0], vert[2][0]),
                               Utils::max(vert[0][1], vert[1][1], vert[2][1]),
                               Utils::max(vert[0][2], vert[1][2], vert[2][2]));

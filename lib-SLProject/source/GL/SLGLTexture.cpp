...
SLstring SLGLTexture::defaultPath      = SLstring(SL_PROJECT_ROOT) + "/_data/images/textures/";
SLstring SLGLTexture::defaultPathFonts = SLstring(SL_PROJECT_ROOT) + "/_data/images/fonts/";

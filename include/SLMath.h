...
SL_floor(T a)
{
    return (T)((SLint)a - ((a < 0 && a != (SLint)(a))));
}
template<class T>
inline T
SL_ceil(T a)
...
template<class T>
inline T
SL_pulse(T a, T b, T x)
{
    return (SL_step(a, x) - SL_step(b, x));
}
template<class T>
inline T
SL_clamp(T a, T min, T max)
{
    return (a < min) ? min : (a > max) ? max : a;
}
template<class T>
inline T
SL_mix(T mix, T a, T b)
{
...
//-----------------------------------------------------------------------------
inline SLbool
SL_isPowerOf2(SLuint a)
{
    return a == 1 || (a & (a - 1)) == 0;
}
//-----------------------------------------------------------------------------
inline SLfloat
SL_random(SLfloat min, SLfloat max)
{

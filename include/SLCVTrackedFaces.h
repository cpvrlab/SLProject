...
class SLCVTrackedFaces : public SLCVTracked
{
    ...
    private:
        ...
        SLVAvgVec2f             _avgPnt2D;      //!< vector of averaged facial landmark 2D points
        SLCVVPoint2d            _cvPnt2D;       //!< vector of OpenCV point2D
        SLCVVPoint3d            _cvPnt3D;       //!< vector of OpenCV point2D

...
//-----------------------------------------------------------------------------
//! Specialized SLInput class for specialized SLCommand input event's.
/*! SLCommand event's can be generated by any GUI system that uses SLProject.
*/
...
public:
    ...
    SLCommandEvent() : SLInputEvent(Command) { }
};

                   ...
                   double alpha)
{
    ...
    vector<Point2i> tMRectInt;
    for(int i = 0; i < 3; i++)
    {
        tMRectFlt.push_back(Point2f(tM[i].x - rM.x, tM[i].y - rM.y));
        tMRectInt.push_back(Point2i(tM[i].x - rM.x, tM[i].y - rM.y)); // for fillConvexPoly
    ...
    multiply(imgM(rM), Scalar(1.0,1.0,1.0) - mask, imgM(rM));
...
int main()
{
    ...
    Mat img1 = imread("../_data/images/textures/hillary_clinton.jpg");
    Mat img2 = imread("../_data/images/textures/donald_trump.jpg");
    ...
    vector<Point2f> points1 = {
        {125,358},{128,402},{132,445},{137,490},{151,532},{178,566},{216,595},{260,616},
        {304,622},{347,612},{388,591},{426,563},{452,526},{466,482},{470,437},{474,392},
        {477,345},{150,332},{171,312},{200,304},{230,307},{259,319},{315,314},{345,299},
        {377,294},{410,300},{434,319},{289,350},{290,382},{291,413},{292,444},{258,458},
        {275,462},{294,467},{313,460},{331,454},{184,358},{201,344},{224,345},{245,363},
        {224,368},{201,368},{339,358},{358,337},{381,335},{401,349},{383,359},{360,361},
        {214,493},{245,489},{274,488},{295,489},{316,485},{346,483},{381,484},{351,524},
        {321,540},{299,543},{277,542},{246,530},{223,495},{275,499},{296,499},{317,496},
        {372,487},{319,523},{298,526},{276,525},{495,400},{264,736},{  0,774},{599,706},
        {  0,  0},{  0,400},{  0,799},{300,799},{599,799},{599,400},{599,  0},{300,  0}};

    //Read points of face 2
    vector<Point2f> points2 = {
        { 80,311},{ 80,357},{ 83,405},{ 88,454},{ 96,502},{114,546},{144,580},{180,607},
        {226,616},{278,611},{335,591},{391,568},{434,531},{464,486},{479,433},{487,377},
        {494,321},{109,259},{126,238},{154,235},{183,239},{212,248},{283,255},{321,244},
        {359,240},{397,247},{427,271},{241,298},{237,327},{232,354},{227,383},{201,418},
        {215,423},{230,427},{250,425},{270,421},{141,301},{159,293},{181,294},{199,309},
        {178,313},{156,311},{309,312},{331,299},{355,298},{376,309},{356,317},{331,317},
        {177,503},{194,484},{213,473},{228,477},{244,474},{271,488},{299,507},{271,523},
        {244,528},{226,528},{209,525},{192,517},{190,500},{213,489},{228,491},{244,491},
        {286,504},{244,508},{228,507},{211,504},{538,410},{215,727},{  0,760},{599,597},
        {  0,  0},{  0,400},{  0,799},{300,799},{599,799},{599,400},{599,  0},{300,  0}};
    ...
    create_delaunay(img1, subdiv, points1, false, triangleIndexes);
    ...
    //while(true)
    {
        ...
        //Calculate weighted average point coordinates

...
extern "C"
{
JNIEXPORT void JNICALL Java_ch_bfh_ar_GLES3Lib_onInit(JNIEnv *env, jobject obj, jint width, jint height, jint dpi, jstring filePath);
...
bool Java_renderRaytracingCallback() {
    jclass klass = environment->FindClass("ch/bfh/ar/GLES3Lib");
